...
function serialize_calculator_ComputeAverageRequest(arg) {
  if (!(arg instanceof proto_calculator_pb.ComputeAverageRequest)) {
...
function deserialize_calculator_ComputeAverageRequest(buffer_arg) {
  return proto_calculator_pb.ComputeAverageRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_calculator_ComputeAverageResponse(arg) {
  if (!(arg instanceof proto_calculator_pb.ComputeAverageResponse)) {
...
function deserialize_calculator_ComputeAverageResponse(buffer_arg) {
  return proto_calculator_pb.ComputeAverageResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_calculator_FindMaximumRequest(arg) {
  if (!(arg instanceof proto_calculator_pb.FindMaximumRequest)) {
...
function deserialize_calculator_FindMaximumRequest(buffer_arg) {
  return proto_calculator_pb.FindMaximumRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_calculator_FindMaximumResponse(arg) {
  if (!(arg instanceof proto_calculator_pb.FindMaximumResponse)) {
...
function deserialize_calculator_FindMaximumResponse(buffer_arg) {
  return proto_calculator_pb.FindMaximumResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
computeAverage: {
    ...
    requestStream: true,
    responseStream: false,
    requestType: proto_calculator_pb.ComputeAverageRequest,
    responseType: proto_calculator_pb.ComputeAverageResponse,
